                ...
                <div class="row ">
                    ...
                    @foreach ($products as $product)
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="card card-product">
                                <img class="card-img-top" src="public/upload/{{ $product->productImage }}"
                                    alt="Card image cap">
                                <div class="card-body">
                 ...
                 {{ $product->productName }}">
                                    ...
                                    <div class="card-text">
                                        ...
                                        <span class="old-price text-secondary"> {{ number_format($product->listPrice) }}đ
                                        </span>
                                        <br>
                                        ...
                                        <a class="btn btn-outline-success btn-detail mt-2 font-weight-bold"
                                            href="{{ route('detail.show', $product->productID, $product->categoryID) }}"> Xem
                                            chi tiết</a>
